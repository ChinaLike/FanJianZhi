 ...
 * 图文item
 */
public class ImgTextContentDelegate extends BaseArtDelegate<MainContentListEntity, ImgTextContentDelegate.ImgContentHolder> {

    public ImgTextContentDelegate(Context context, AbsRvDAdapter adapter, int itemType) {
    ...
    public void bindData(int position, ImgContentHolder holder, MainContentListEntity item) {
        ImgTextEntity entity = item.getImgTextContent();
